...
<h2 style="text-align: center;">DAFTAR SISWA MAN 2 KUDUS</h2>
<h3 style="text-align: center;">KELAS A</h3>

<div class="section">
    <div class="container">
        <table class="table" border="1px" cellspacing="0" cellpadding="10" style="padding:50px">
            ...
            <tbody>
                <?php $result= mysqli_query($conn, "SELECT * FROM students ORDER BY id ASC"); ?>
                <?php $i=1;
